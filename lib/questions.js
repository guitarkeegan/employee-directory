...
const addEmployeeQuestions = [
    ...
    }, 
    {
        type: "input",
        name: "role",
        message: "What is their title or 'role'? (use role_id or title) ",
        validate: value=>{
            if (value){
                return true;
            } else {
    ...
    },
    {
        type: "input",
        name: "managerId",
        message: "If the previous answer was no, please write the ID or name of their manager. ",
...
module.exports = {addDepartmentQuestions, addRoleQuestions, addEmployeeQuestions}