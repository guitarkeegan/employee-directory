...
const addEmployeeQuestions = [
    ...
    }, 
    {
        type: "input",
        name: "role",
        message: "What is their title or 'role'? (use the role_id column on the left) ",
        validate: value=>{
            const number = !isNaN(value);
            if (number && value){
                return true;
...
const updateEmployeeRoleQuestions = [
    ...
    },
    {
        type: "input",
        name: "newRole",
        message: "What will this employee's new role be? (use role_id above. Second column from right) ",
        validate: value=>{
            const number = !isNaN(value);
            if (number && value){
                return true;
...
module.exports = {addDepartmentQuestions, addRoleQuestions, addEmployeeQuestions, updateEmployeeRoleQuestions, deleteDepartmentQuestions, updateEmployeeManagerQuestions, deleteEmpQuestions, deleteRoleQuestions, empByDeptQuestions, empByManagerQuestion, totalUtilizedBudgetQuestion, mainMenuQuestions}